...
//  DemoProject
//
//  Created by Ahmed kamal on 4/1/20.
...
extension UIView {
    ...
    func lock(frameRect: CGRect = CGRect.zero) {
        if (viewWithTag(10) != nil) {
            ...
            let spinner = JHSpinnerView.showOnView(self, spinnerColor: #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1), overlay:.circular, overlayColor:   #colorLiteral(red: 0.652874887, green: 0.4995334148, blue: 0.4834066033, alpha: 1).withAlphaComponent(0.8)
